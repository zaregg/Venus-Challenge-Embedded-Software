 ...
 */
#define XIIC_STOP                                                              \
  0x00 /**< Send a stop on the IIC bus after                                   \
        * the current data transfer */
#define XIIC_REPEATED_START                                                    \
  0x01 /**< Donot Send a stop on the IIC bus after                             \
        * the current data transfer */
...
#define XIic_IntrGlobalEnable(BaseAddress)                                     \
  XIic_WriteReg((BaseAddress), XIIC_DGIER_OFFSET, XIIC_GINTR_ENABLE_MASK)
...
#define XIic_IsIntrGlobalEnabled(BaseAddress)                                  \
  (XIic_ReadReg((BaseAddress), XIIC_DGIER_OFFSET) == XIIC_GINTR_ENABLE_MASK)
