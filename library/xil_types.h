...
/**
 *
 * The xil_types.h file contains basic types for Xilinx software IP. These data
 *types are applicable for all processors supported by Xilinx.
 * <pre>
...
#define XIL_COMPONENT_IS_READY                                                 \
  0x11111111U /**< In device drivers, This macro will be                       \
               assigend to "IsReady" member of driver                          \
                                                               instance to     \
               indicate that driver instance is initialized and ready to use.  \
             */
#define XIL_COMPONENT_IS_STARTED                                               \
  0x22222222U /**< In device drivers, This macro will be assigend to           \
               "IsStarted" member of driver instance                           \
                                                               to indicate     \
               that driver instance is started and it can be enabled. */
